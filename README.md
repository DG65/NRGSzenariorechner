...
**Stand:** Phase 3 (Version 0.3.0-beta.1) — Szenarien "Dynamischer Vertrag vs. Festpreis",
"Speichergröße" und "§14a-Beitritt". Konzept für alle vier Szenario-Typen: [KONZEPT.md](KONZEPT.md).
