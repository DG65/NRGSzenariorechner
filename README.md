...
**Stand:** Phase 3 (Version 0.4.0-beta.1) — Szenarien "Dynamischer Vertrag vs. Festpreis",
"Speichergröße" und "§14a-Beitritt", je Szenario eine Ergebnisvariable an der Instanz.
